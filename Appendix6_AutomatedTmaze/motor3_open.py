# Python script | Appendix 6: Automated T-maze gates - motor3_open.py
...
steps_i_ = open("/home/pi/steps_motor3.txt")
steps_i = steps_i_.read(3)
steps_i = int(steps_i)
GPIO.cleanup()
GPIO.setmode(GPIO.BCM)

state = open("/home/pi/state_motor3.txt") #read state
state = state.read(3)
state = int(state)
...
os.system("echo " + str(i) + " > /home/pi/steps_motor3.txt")
#save steps
os.system("echo '0' > /home/pi/state_motor3.txt")
GPIO.cleanup()
